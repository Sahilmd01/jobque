...
const AppDownload = () => {
  return (
    <div className='container px-4 2xl:px-20 mx-auto my-12'>
      <motion.div 
        className='relative bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-xl p-6 sm:p-10 lg:p-12 overflow-hidden'
        ...
        <div className="flex flex-col lg:flex-row items-center gap-6">
          ...
          <div className="lg:w-1/2">
            <motion.h1 
              ...
              viewport={{ once: true }}
            >
              Download App for <span className="text-indigo-400">Better Experience</span>
            </motion.h1>
